  ...
  return (
    <div className="space-y-2 text-white">
      <p className="flex items-center gap-4">
        ...
        <a
          href="tel:+2126621225820"
          className="hover:underline"
          aria-label="phone number +2126621225820"
        >
          +212 661 225 820
        </a>
      </p>
      <p className="flex items-center gap-4">
        ...
        <a
          ...
          className="hover:underline"
          aria-label="email tangierguidedtour@gmail.com"
        >
      ...
      <p className="flex items-center gap-4">
        ...
        <a
          href="whatsapp://send?phone=212661225820"
          className="hover:underline"
          aria-label="chat on whatsapp 212 661 225 820"
        >
          +212 661 225 820
        </a>
      </p>
